...
export const GITHUB_URL = 'https://github.com/YashPathak1446';
export const LINKEDIN_URL = 'https://www.linkedin.com/in/yash-pathak-6074a1210/';
export const EMAIL = 'yashpathak1446@gmail.com';